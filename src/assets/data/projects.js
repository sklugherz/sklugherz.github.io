...
const projects = [
    {title: 'ReqScaner', img: '', keywords: 'Python, NVD, API, CLI', desc: 'A simple CLI tool; Checks required project dependencies against the National Vulernability Database. Generates a report of vulnerabilty findings.'}, 
    ...
    {title: 'Censorer', img:'', keywords: 'C++, CLI', desc: 'CLI tool for censoring text files or a stream of text given a custom set of prohibited words.'},
    {title: 'TV Menu', img:'', keywords: 'C++', desc: 'A look into what the back-end logic of a TV menu might look like.'},
